...
namespace fm {
	...
	mat4::mat4(FMFLOAT _m00, FMFLOAT _m01, FMFLOAT _m02, FMFLOAT _m03, FMFLOAT _m10, FMFLOAT _m11, FMFLOAT _m12, FMFLOAT _m13, FMFLOAT _m20, FMFLOAT _m21, FMFLOAT _m22, FMFLOAT _m23, FMFLOAT _m30, FMFLOAT _m31, FMFLOAT _m32, FMFLOAT _m33)
		noexcept :__data{ vector4(_m00,_m01,_m02,_m03),vector4(_m10,_m11,_m12,_m13),vector4(_m20,_m21,_m22,_m23),vector4(_m30,_m31,_m32,_m33) }
	{
	}

	mat4::mat4(const vector4& vec0, const vector4& vec1, const vector4& vec2, const vector4& vec3)
		noexcept :__data{ vec0,vec1,vec2,vec3 }
	{
	}
	...
	vector4& FM_CALL mat4::operator[](size_t t) noexcept
	{
		return __data[t];
	}
	...
	const fm::vector4 FM_CALL operator*(const fm::vector4& veca, const fm::mat4& b) noexcept
	{
		...
		simd::_fm_vec4 b2 = simd::fmLoadVec(b[0][2], b[1][2], b[2][2], b[3][2]);
		simd::_fm_vec4 b3 = simd::fmLoadVec(b[0][3], b[1][3], b[2][3], b[3][3]);
		return vector4(simd::fmVecDot(a, b0), simd::fmVecDot(a, b1), simd::fmVecDot(a, b2), simd::fmVecDot(a, b3));
	}
	const fm::vector4 FM_CALL operator*(const fm::mat4& mata, const fm::vector4& vecb) noexcept
	{
